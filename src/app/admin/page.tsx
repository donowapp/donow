              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 gap-4 sm:grid-cols-4">
                  {[
                    ...
                    { label: 'Flagged',             value: stats.flaggedDonations,   color: stats.flaggedDonations > 0 ? 'text-orange-400' : 'text-gray-500', tab: 'moderation' as Tab },
                  ].map((s) => (
                    <button
                      key={s.label}
                      onClick={() => setTab(s.tab)}
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-3 sm:grid-cols-3">
                  <div className="rounded-xl bg-white p-4 shadow text-center">
                    <p className={`text-2xl font-bold ${flaggedDonations.length > 0 ? 'text-orange-400' : 'text-gray-400'}`}>{flaggedDonations.length}</p>
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-2 gap-3 sm:grid-cols-3 lg:grid-cols-6">
                  {[
                    ...
                    { label: 'Flagged',            value: stats.flaggedDonations,   color: stats.flaggedDonations > 0 ? 'text-orange-400' : 'text-gray-400', icon: '⚠️' },
                  ].map((s) => (
                    ...
                    <div className="rounded-xl bg-white p-6 shadow space-y-4">
                      ...
                      <label className="flex items-center justify-between gap-4 cursor-pointer">
                        ...
                        <div
                          ...
                          className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors flex-shrink-0 ${settingsData.maintenanceMode ? 'bg-orange-400' : 'bg-gray-300'}`}
                        >
                    ...
                    <div className="divide-y">
                      {filteredLogs.map((l) => {
                        const actionColors: Record<string, string> = {
                          ...
                          donation_flag:     'bg-orange-100 text-orange-500',
