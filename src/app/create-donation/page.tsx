        ...
        <form onSubmit={handleSubmit} className="rounded-lg bg-white p-6 shadow">
          ...
          <div className="mb-5">
            ...
            <input
              ...
              className="w-full rounded-lg border border-gray-300 px-4 py-2 text-sm outline-none transition file:mr-4 file:rounded file:border-0 file:bg-violet-50 file:px-3 file:py-2 file:text-sm file:font-semibold file:text-violet-700 focus:border-transparent focus:ring-2 focus:ring-violet-500"
            />
