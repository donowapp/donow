          ...
          <div className="flex flex-col items-center pb-2">
            <div className="relative">
              {avatarSrc ? (
                ...
                <div className="w-24 h-24 rounded-full bg-violet-100 flex items-center justify-center text-3xl font-bold text-violet-600">
                  {initials}
                </div>
              )}
              <button
                ...
                className="absolute bottom-0 right-0 bg-violet-600 text-white rounded-full p-1.5 hover:bg-violet-700 transition shadow"
