          ...
          <div className="bg-white rounded-lg shadow p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-teal-600 mt-2">{user.donationCount || 0}</p>
              </div>
          ...
          <div className="bg-white rounded-lg shadow p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-teal-600 mt-2">{user.receivedCount || 0}</p>
              </div>
              <div className="text-4xl">📦</div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-teal-600 mt-2">{(user.rating || 0).toFixed(1)}</p>
              </div>
              <div className="text-4xl">⭐</div>
            </div>
          </div>
